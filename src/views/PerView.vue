    ...
    <div class="per-view-content pt15 pl2 pr2">
      ...
      <div class="content-list pt15 pb15">
        ...
        <div class="content-list__body f fw aic">
          <router-link to="/detail" v-for="(item, index) in personnelActive" :key="index" class="w100">
            <div class="item-person f jcb aic w100 border-radius mb1 pr15 pl15 pt1 pb1 bg-white-1">
              <div class="mr2">
                <input class="checkbox" type="checkbox"> 
              </div>
